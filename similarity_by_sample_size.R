...
library(ggplot2)
ggplot(dat_RS, aes(samples, comparisons)) + geom_point() + theme_bw() + facet_wrap(~trait, ncol = 2)
ggsave("~/Dropbox/labbio/articles/VCV/RS_SampleSize.png")
ggplot(dat_Krz, aes(samples, comparisons)) + geom_point() + theme_bw() + facet_wrap(~trait, ncol = 2)
ggsave("~/Dropbox/labbio/articles/VCV/Krz_SampleSize.png")
ggplot(dat_Mantel, aes(samples, comparisons)) + geom_point() + theme_bw() + facet_wrap(~trait, ncol = 2)
ggsave("~/Dropbox/labbio/articles/VCV/Mantel_SampleSize.png")
ggplot(dat_Krz_corr, aes(samples, comparisons)) + geom_point() + theme_bw() + facet_wrap(~trait, ncol = 2)
ggsave("~/Dropbox/labbio/articles/VCV/KrzCor_SampleSize.png")
